...
export default function HadithBlogLogin(){
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res= await fetch(`${BASE_API}/api/auth/hadithBlogLogin`,{
                method:"POST",
                headers: { 
            ...
            if(res.ok){
                localStorage.setItem('hadithBlogLoginSession', data.token);
                localStorage.setItem('hadithBlogUserInfo', JSON.stringify(data.rest));
