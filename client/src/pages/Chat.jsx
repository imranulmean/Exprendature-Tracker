        ...
        <>
            ...
            <div className="w-1/3 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div className="overflow-y-auto flex-1">
                    {
                        Object.entries(onlineUsers).map(([sId, uId]) => {
                            if(sId === me) return null; 
                            const isUnread = unread.includes(sId);
                            return (
                                <div key={sId} onClick={() => handleUserClick(sId)}
                                    className={`p-4 border-b cursor-pointer flex justify-between items-center transition-all ${
                                        selectedUser === sId ? "bg-indigo-50 border-r-4 border-r-indigo-500" : "hover:bg-gray-50"
            ...
            <div className="w-2/3 flex flex-col">
                ...
                <>
                    ...
                    <span className="font-bold text-gray-700">Chatting with {selectedUser}</span>
